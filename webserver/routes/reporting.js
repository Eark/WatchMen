var services_loader = require ('../../lib/dynamic-services');
...
module.exports.add_routes = function (app, storage){
  ...
  app.get('/details', function(req, res){
    ...
    //
    // Never errors cause this has been cached the first time around
    // If it errored then, process crashed.
    //
    services_loader.load_services(function (_, services) {
